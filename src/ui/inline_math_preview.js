...
import '../../theme/mathform.css';
  ...
  */
 export class InlineMathInput extends View {
	 /**
	  * @inheritDoc
	  */
	 constructor( locale ) {
...
export class InlineMathPreview extends View {
